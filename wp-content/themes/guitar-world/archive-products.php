                ...
                <nav class="catalog-nav">
                    ...
                    <ul class="catalog-nav__wrapper">
                        <li class="catalog-nav__item">
                            <a href="<?php echo get_home_url(null, 'products/')?>" class="catalog-nav__btn is-active">все</a>
                        </li>
                        <?php
                        if ( $catalog_nav_items ):
                            foreach ( $catalog_nav_items as $item ):
                                ...
                                <li class="catalog-nav__item">
                                    <a href="<?php echo get_home_url(null, 'product_categories/'.$item->slug)?>" class="catalog-nav__btn" type="button">
                                        <?php echo $item->name ?>
                                    </a>
                                </li>
                            <?php
