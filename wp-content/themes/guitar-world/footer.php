        ...
        <div class="popup__inner">
            <div class="popup__content popup__content--fluid popup__content--centered">
                ...
                <div class="phone popup__phone">
                    <a class="phone__item phone__item--accent" href="tel:<?= $GLOBALS['guitar']['phone-digit'] ?>">
    ...
    <div class="popup__wrapper">
        <div class="popup__inner">
            <div class="popup__content">
                ...
                <p class="popup__subtitle popup__subtitle--order">Мы привезем вам этот прекрасный инструмент</p>
                <div class="order">
    ...
    <div class="popup__wrapper">
        <div class="popup__inner">
            <div class="popup__content">
                ...
                <p class="popup__subtitle">Пожалуйста, сделайте заказ по номеру
                    <a class="popup__link"
                       href="<?= $GLOBALS['guitar']['phone-digit'] ?>">
                        <?= $GLOBALS['guitar']['phone'] ?>
                    </a>
                </p>
            </div>
