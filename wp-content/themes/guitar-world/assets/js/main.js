...
;(function () {
    ...
    myLib.body.addEventListener('click', function (e) {
        var target = e.target;
        var popupClose = myLib.closestItemByClass(target, 'popup-close');
        if (popupClose ||
...
;(function () {
    ...
    //смена цены при клике на атрибуты
    var changeProductOrderInfo = function (target) {
        var product = myLib.closestItemByClass(target, 'product');
        var order = document.querySelector('.popup-order');

        let productSizeItem = product.querySelector('.product__size.is-active');
...
;(function () {
    ...
    var ymapInit = function () {
        ...
        let map_item = document.querySelector('.contacts__map').getAttribute('data-coordinates');
        let coor = WPJS['coor'].split(',')
        console.log(coor)
        ...
        ymaps.ready(function () {
            ...
            var myMap = new ymaps.Map('ymap', {
                ...
                myPlacemark = new ymaps.Placemark(myMap.getCenter(), {
                    balloonContent: WPJS.address
                }, {
                    iconLayout: 'default#image',
                    iconImageHref: WPJS['siteUrl'] + '/assets/img/common/marker.png',
